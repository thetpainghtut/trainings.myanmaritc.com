                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="type" id="offline_id" value="Offline">
                            <label class="form-check-label" for="offline_id"> Offline </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="type" id="online_id" value="Online">
